...
const CounterCard: React.FC<CounterCardProps> = memo(({ count, label }) => {
  return (
    <div className="flex flex-col justify-center items-center text-center p-4 sm:p-5 rounded-lg backdrop-blur-lg bg-white/10 border border-white/20 shadow-md w-full max-w-xs sm:max-w-sm md:max-w-52 lg:max-w-60 fade-in">
