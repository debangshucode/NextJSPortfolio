          ...
          <div className="flex gap-8">
            <div className="flex-grow space-y-6">
              ...
              <p className="text-xl text-gray-400">
                ...
                strategy, security, and seamless execution. We specialize in Web
                & E-commerce Development, App Development, UI/UX Design, SEO,
                Logo Design, Power BI, QA, and Cybersecurity, delivering
                tailored solutions that elevate brands.
              </p>

              <p className="text-xl text-gray-400">
                From creating stunning digital experiences to securing your
                online presence, we blend creativity, technology, and analytics
                to help you grow. Whether it&apos;s crafting a high-performing
                website, optimizing for search engines, or ensuring top-tier
                security, we make every detail count.
              </p>
